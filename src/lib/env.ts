 ...
 * Source: _workspace/01_architecture.md §10.
 *
...
const publicEnvSchema = z.object({
  ...
  NEXT_PUBLIC_STRIPE_PRICE_SINGLE: z.string().min(1).optional(),
  NEXT_PUBLIC_STRIPE_PRICE_WEEKLY: z.string().min(1).optional(),
  NEXT_PUBLIC_STRIPE_PRICE_MONTHLY: z.string().min(1).optional(),
...
export const publicEnv = publicEnvSchema.parse({
  ...
  NEXT_PUBLIC_STRIPE_PRICE_SINGLE: process.env.NEXT_PUBLIC_STRIPE_PRICE_SINGLE,
  NEXT_PUBLIC_STRIPE_PRICE_WEEKLY: process.env.NEXT_PUBLIC_STRIPE_PRICE_WEEKLY,
