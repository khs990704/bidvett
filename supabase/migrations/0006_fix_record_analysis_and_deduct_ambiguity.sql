-- 0006_fix_record_analysis_and_deduct_ambiguity.sql
-- Fix 42702 "column reference balance_after is ambiguous".
-- The RETURNS TABLE column `balance_after` was shadowing
-- credit_ledger.balance_after inside the function body.
-- Resolution: qualify every reference with a table alias.
